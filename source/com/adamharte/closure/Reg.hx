...
class Reg
{
	...
	static public var bulletWoundGibs:FlxEmitter;
	static public var goreGibs:FlxEmitter;
	static public var goreSmallGibs:FlxEmitter;
	//static public var explosionGibs:FlxEmitter;
